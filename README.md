...
If we use `include` keyword, we allow our classes to use all of the methods of the included module as _instance_ methods. We'll talk about how to lend a module's methods as _class_ methods in a minute.
